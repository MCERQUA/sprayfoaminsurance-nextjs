      ...
      <section className="py-12 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-surface/50 rounded-2xl p-8 lg:p-12 border border-primary/10">
            ...
            <p className="text-muted leading-relaxed mb-5">For auto and property insurance, the specifics matter:</p>
            <p className="text-muted leading-relaxed mb-5">Vehicle Type: The make, model, age, and safety features of your car can affect auto insurance rates. Home Details: Home insurance premiums are influenced by factors like the age and condition of your home, the materials used in construction, and security features.</p>

            <h2 className="text-2xl font-headline font-bold text-text mt-10 mb-4">Annual Mileage (Auto Insurance):</h2>
